package com.daiict.smartcity.myosa.bluetooth_connectivity;
...
import com.daiict.smartcity.myosa.Dashboard;
...
public class BluetoothComService {
    ...
    /**
     * Constructor. Prepares a new BluetoothTerm session.
     *
     * @param context The UI Activity Context
     * @param handler A Handler to send messages back to the UI Activity
     */
    public BluetoothComService(Context context, Handler handler) {
    ...
    private class ConnectThread extends Thread {
        ...
        public void run() {
            ...
            try {
                ...
                BluetoothComService.this.start();
                return;
            }
    ...
    private class ConnectedThread extends Thread {
        ...
        public void run() {
            BufferedReader p = new BufferedReader(new InputStreamReader(mmInStream));
            String buffer;
            int bytes;
